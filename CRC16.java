public class CRC16 {
    public static void main(String[] args) {
        ...
        CRCResult =MethodCRC16(Data, 0);
        System.out.print("CRC16  = ");
        System.out.println(CRCResult);
  }

    static int[] table = { 0, 4129, 8258, 12387, 16516, 20645, 24774, 28903, 33032, 37161, 41290, 45419, 49548, 53677, 57806,
    ...
    public static int MethodCRC16(String paramString, int paramInt)
    {
        int i = 0;
